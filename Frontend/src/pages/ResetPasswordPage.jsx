...
import { Eye, EyeOff, Lock, ArrowLeft, Zap, CheckCircle2 } from 'lucide-react';
...
export function ResetPasswordPage() {
  ...
  return (
    ...
    >
      {/* 100% Video Background - Plays exactly once */}
      <video
        src="/Login-Video.mp4"
        autoPlay
        muted
      ...
      >
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          >
            Set a secure new password for your organization account
          </p>
        </div>
        ...
        {done ? (
          ...
          <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <button
              ...
              disabled={submitting}
            >
              {submitting ? <><span className={s.spinner} /> Resetting Password...</> : 'Save New Password'}
            </button>
          </form>
        )}
